...
import arcadeHome from "../assets/projects/arcade_homepage.png";
import arcadeEevees from "../assets/projects/arcade_eevees.png";
import arcadeToast from "../assets/projects/arcade_toast.png";
...
export default function Projects() {
    const projects = [
        {
            ...
            text: (
                <p>
                    Since university I have been learning and practicing web development using <strong className="text-yellow-100">React</strong>. I began by making this portfolio page, learning React just by doing it. After this site was complete, I began work on learning the finer details of React using <a className="text-yellow-100 font-bold underline" href="https://www.theodinproject.com/paths/full-stack-javascript/courses/react">The Odin Project</a> and the React documentation. Throughout this experience I learned more details on React's hooks, how to deal with legacy React code and how to debug, test and fetch external data more efficiently.<br className="mb-3" />
                    After this, I began working on a new website, the <a className="font-bold text-yellow-100 underline" href="https://jamming-arcade.netlify.app/">Jamming Arcade</a>. I built a homepage and two games, one of which is a Pokémon-themed memory game and the other is a Cookie Clicker-based clicking game. The Jamming Arcade is programmed in React with <strong className="text-yellow-100">TypeScript</strong> which is a language I had never touched before and I now feel much more confident using it.<br className="mb-3" />
                    Please check out my games and this website's <Link to="/blog" className="font-bold text-yellow-100 underline">Blog</Link> to see updates on what I am learning and developing!
                </p>
            ),
            images: [
                {src: arcadeHome, caption: "The homepage of the Jamming Arcade"},
                {src: arcadeEevees, caption: "My Pokémon-themed memory game"},
                {src: arcadeToast, caption: "My clicker game"}
            ]
        },
        { 
    ...
    return (
        <div className="prose max-w-5xl mx-auto">
            <h1 className="text-4xl font-bold mb-4 mt-6 md:mt-0">My Projects</h1>
            <p className="text-lg">
