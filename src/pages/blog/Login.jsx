...
export default function Login() {
    return (
        <div className="p-4 mt-16 max-w-3xl mx-auto text-center bg-gray-300/90 text-gray-800 rounded">
            ...
            <input placeholder="Username or Email Address" className="w-full mb-2 p-2 border bg-gray-200" />
            <input type="password" placeholder="Password" className="w-full mb-2 p-2 border bg-gray-200" />
